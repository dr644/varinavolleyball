    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.request:
            ...
            if self.request.method == "GET" or \
               "captcha_sum" not in self.request.session or \
               "captcha_text" not in self.request.session:
            ...
            self.fields["math_question"].initial = self.request.session.get("captcha_text", "Solve the sum.")
